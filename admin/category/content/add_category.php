...
<div class="container mt-4 text-primary">
  ...
  <form method="post" action="content/insert.php" class="text-center text-dark border rounded border-2 bg-light" enctype="multipart/form-data">
    ...
    <div class=" px-5 mx-5 ">
      ...
      <div class="m-3">
        ...
        <input class="form-control text-dark  " type="text" name="cat_name" placeholder="Add Title" required minlength="3" maxlength="20" autofocus value="" />
      </div>
