...
<div class="container mt-4">
    <form class="text-center border rounded border-2 bg-light" method="post" action="post.php">
        ...
        <div class=" text-dark px-5 mx-5" style="padding-right: 30px;padding-left: 30px;padding-top: 10px;padding-bottom: 10px;">
          <input class="form-control text-dark" type="file"  type="file" name="img" accept="image/*" />
        </div>
        
        <article style="padding-right: 30px;padding-left: 30px;padding-top: 10px;padding-bottom: 10px;">
          <textarea class="form-control text-dark" name="Paragraph" placeholder="Add Paragraph" minlength="3" maxlength="500" required></textarea>
        </article>
