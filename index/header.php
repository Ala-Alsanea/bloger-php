      ...
      <section class="carousel-item active " data-bs-interval="2000">
        <div class="container py-5 text-center">
          <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
            <div class="col mb-5">
              <img src="_utilities/img/<?php echo basename($posts['img_name']) ?>" class=" img-fluid shadow rounded" style="border-radius: 1rem !important; max-height: 30rem;" />
            </div>
      ...
      <?php while ($posts = mysqli_fetch_assoc($re)) { ?>
        <section class="carousel-item " >
          <div class="container py-5 text-center">
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
              <div class="col mb-5">
                <img src="_utilities/img/<?php echo basename($posts['img_name']) ?>" class="rounded img-fluid  shadow" style="border-radius: 1rem !important; max-height: 30rem;" />
              </div>
